# db/queue_migrate/20260528000100_create_solid_queue_tables.rb
...
class CreateSolidQueueTables < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :solid_queue_jobs, :queue_name, if_not_exists: true
    add_index :solid_queue_jobs, :scheduled_at, if_not_exists: true
    ...
    add_index :solid_queue_processes, :name, unique: true, if_not_exists: true
